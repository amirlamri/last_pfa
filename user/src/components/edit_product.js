        ...
        return (
            ...
            <div className="container">
                ...
                <div className="col-md-9  text-center">
                    <h1 className="mb-0 bread">Edit product </h1>
                    <p className="breadcrumbs"><span className="mr-2"><a href="/">Home</a></span> <span>Edit product</span></p>
                </div>
                </div>
            </div>
        </div>
                            ...
                            <div className="card-body bg-light">
                                <form action="#" className="bg-white p-5 contact-form bg-light">
                                    ...
                                    <div className="form-actions">
                                        <button type="submit" className="btn btn-warning py-2 px-3" onClick="" ><span className="icon icon-edit"></span> Edit</button>
                                        <button type="submit" className="btn btn-danger py-2 px-3" onClick="" ><span className="icon icon-trash"></span> delete</button>
                                        <button type="button" className="btn btn-inverse py-2 px-3" onClick="/my_products" >Back</button>
                                    </div>
                                </form>
                            </div>
                        </div>
