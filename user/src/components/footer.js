							...
							<div className="col-md">
								<div className="ftco-footer-widget mb-4">
									...
									<ul className="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
										<li className="ftco-animate"><a href="#"><span className="icon-twitter"><span className="icon icon-twitter"></span></span></a></li>
										<li className="ftco-animate"><a href="#"><span className="icon-facebook"><span className="icon icon-facebook"></span></span></a></li>
										<li className="ftco-animate"><a href="#"><span className="icon-instagram"><span className="icon icon-instagram"></span></span></a></li>
									</ul>
								</div>
							</div>
							<div className="col-md">
