                                        ...
                                        <div className="row p-t-20">
                                            ...
                                            <div className="col-md-6">
                                                <div className="form-group has-danger">
                                                    ...
                                                    <textarea className="form-control rounded-0 form-control-danger" id="exampleFormControlTextarea2" rows="3" placeholder="Magasin description ..."></textarea>
                                                    <small className="form-control-feedback"> This field has error. </small> </div>
                                            </div>
                                            <div className="col-md-6">
                                                <div className="form-group has-danger">
                                                    <label className="control-label text-info"> Magasin address </label>
                                                    <input type="text" id="Magasin address" className="form-control" placeholder="Magasin address"/>
                                                    <small className="form-control-feedback"> This field has error. </small> </div>
                                            </div>
                                            <div className="col-md-6">
                                                <div className="form-group">
