...
import Commands_celler from './components/commands_celler';
      ...
      <Router>
        ...
        <Header />
          ...
          <div className="container">
            ...
            <Route exact path="/my_products" component={My_products} />
            <Route exact path="/edit_product" component={Edit_product} />
            <Route exact path="/commands_celler" component={Commands_celler} />
          </div>
          <Footer />
        </div>
      </Router>
